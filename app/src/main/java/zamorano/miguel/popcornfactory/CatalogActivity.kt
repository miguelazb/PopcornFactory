...
class CatalogActivity : AppCompatActivity() {
    ...
    var adapterPelis:PeliculaAdapter? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        cargarPeliculas()
        adapterPelis = PeliculaAdapter(this, peliculas)
        adapterSeries = SerieAdapter(this,series)
        movies_catalog.adapter = adapterPelis
        series_catalog.adapter = adapterSeries
    }
